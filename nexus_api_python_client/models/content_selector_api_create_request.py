...
class ContentSelectorApiCreateRequest(object):
    ...
    def __init__(self, name=None, description=None, expression=None, local_vars_configuration=None):  # noqa: E501
        """ContentSelectorApiCreateRequest - a model defined in OpenAPI"""  # noqa: E501
