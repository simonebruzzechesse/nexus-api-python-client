...
class ContentSelectorsApi(object):
    ...
    def create_content_selector(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/beta/security/content-selectors', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_content_selector(self, name, **kwargs):  # noqa: E501
        ...
        return self.delete_content_selector_with_http_info(name, **kwargs)  # noqa: E501
    ...
    def delete_content_selector_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `name` when calling `delete_content_selector`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/beta/security/content-selectors/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_content_selector(self, name, **kwargs):  # noqa: E501
        """Get a content selector by id  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
                                                        local_var_params['name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `name` when calling `get_content_selector`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/beta/security/content-selectors/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_content_selectors(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/beta/security/content-selectors', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_content_selector(self, name, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_content_selector_with_http_info(name, **kwargs)  # noqa: E501
    ...
    def update_content_selector_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
                                                        local_var_params['name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `name` when calling `update_content_selector`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/beta/security/content-selectors/{name}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
